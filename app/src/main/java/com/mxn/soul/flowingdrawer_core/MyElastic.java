 ...
 * ElasticDrawer
 */
public abstract class MyElastic extends ViewGroup {
     ...
     */
    private com.mxn.soul.flowingdrawer_core.MyElastic.OnDrawerStateChangeListener mOnDrawerStateChangeListener;
    /**
     * Callback that lets the listener override intercepting of touch events.
     */
    protected com.mxn.soul.flowingdrawer_core.MyElastic.OnInterceptMoveEventListener mOnInterceptMoveEventListener;
    ...
    public MyElastic(Context context) {
        super(context);
    }

    public MyElastic(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.elasticDrawerStyle);
    }

    public MyElastic(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void animateOffsetTo(int position, int duration, float eventY) {
        final int startX = (int) mOffsetPixels;
        final int dx = position - startX;
        if (getPosition() == com.mxn.soul.flowingdrawer_core.MyElastic.Position.LEFT) {
            if (dx > 0) {
    ...
    protected int getPosition() {
        ...
        switch (mPosition) {
            case com.mxn.soul.flowingdrawer_core.MyElastic.Position.START:
                if (layoutDirection == LAYOUT_DIRECTION_RTL) {
                    return com.mxn.soul.flowingdrawer_core.MyElastic.Position.RIGHT;
                } else {
                    return com.mxn.soul.flowingdrawer_core.MyElastic.Position.LEFT;
                }
            case com.mxn.soul.flowingdrawer_core.MyElastic.Position.END:
                if (layoutDirection == LAYOUT_DIRECTION_RTL) {
                    return com.mxn.soul.flowingdrawer_core.MyElastic.Position.LEFT;
                } else {
                    return com.mxn.soul.flowingdrawer_core.MyElastic.Position.RIGHT;
    ...
    public void setOnDrawerStateChangeListener(com.mxn.soul.flowingdrawer_core.MyElastic.OnDrawerStateChangeListener listener) {
     ...
     */
    @SuppressWarnings("unused")
    public void setOnInterceptMoveEventListener(com.mxn.soul.flowingdrawer_core.MyElastic.OnInterceptMoveEventListener listener) {
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        com.mxn.soul.flowingdrawer_core.MyElastic.SavedState state = new com.mxn.soul.flowingdrawer_core.MyElastic.SavedState(superState);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        com.mxn.soul.flowingdrawer_core.MyElastic.SavedState savedState = (com.mxn.soul.flowingdrawer_core.MyElastic.SavedState) state;
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Creator<com.mxn.soul.flowingdrawer_core.MyElastic.SavedState> CREATOR = new Creator<com.mxn.soul.flowingdrawer_core.MyElastic.SavedState>() {
            @Override
            public com.mxn.soul.flowingdrawer_core.MyElastic.SavedState createFromParcel(Parcel in) {
                return new com.mxn.soul.flowingdrawer_core.MyElastic.SavedState(in);
            }

            @Override
            public com.mxn.soul.flowingdrawer_core.MyElastic.SavedState[] newArray(int size) {
                return new com.mxn.soul.flowingdrawer_core.MyElastic.SavedState[size];
            }
        };
    }
    ...
    protected boolean canChildrenScroll(int dx, int x, int y) {
        ...
        switch (getPosition()) {
            case com.mxn.soul.flowingdrawer_core.MyElastic.Position.LEFT:
            case com.mxn.soul.flowingdrawer_core.MyElastic.Position.RIGHT:
                if (!mMenuVisible) {
