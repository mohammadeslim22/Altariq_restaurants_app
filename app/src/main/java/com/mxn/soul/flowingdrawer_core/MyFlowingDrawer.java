 ...
 * FlowingDrawer
 */
public class MyFlowingDrawer extends MyElastic {

    public MyFlowingDrawer(Context context) {
        super(context);
    }

    public MyFlowingDrawer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyFlowingDrawer(Context context, AttributeSet attrs, int defStyle) {
